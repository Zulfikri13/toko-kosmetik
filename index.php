    ...
    <section id="login" class="section-margin" style="margin-bottom: 100pt;">
     ...
     <section id="tentang" class="section-margin" style="margin-bottom: 100pt;">
      ...
      <div class="col-lg-12 danger text-center zero-panel">
        <div class="col-lg-12 zero-panel-content">
          <div class="jumbotron">
          <h1>Toko Kosmetik </h1><br>
          <p>Selamat datang di Toko Kosmetik, destinasi utama Anda untuk segala kebutuhan kecantikan! Kami adalah toko kosmetik yang berdedikasi untuk menyediakan produk-produk berkualitas tinggi dengan harga terjangkau, sehingga setiap orang dapat merasa cantik dan percaya diri setiap hari. </p>
          <p>Jl. Ring Road Utara, Ngringin, Condongcatur, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta</p>  
          </div>
