...
if (isset($_POST['go'])) {
    $cari = $_POST['cari'];
     ...
     $data_kategori= mysqli_query($koneksi, "SELECT * FROM tb_barang WHERE nama_brg LIKE '%".$cari."%'");
}else{
     $data_kategori = mysqli_query($koneksi, "SELECT * FROM tb_barang LIMIT $halaman_awal, $batas");
}
